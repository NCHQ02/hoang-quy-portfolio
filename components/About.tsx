...
const CursorIcon = ({ className }: { className?: string }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className={`drop-shadow-md ${className}`}>
...
const SelectionHandle = ({ className }: { className?: string }) => (
  <div className={`absolute w-2.5 h-2.5 bg-white border border-design-blue z-20 ${className}`} />
);
...
const UIPanel: React.FC<UIPanelProps> = ({ children, className, delay = 0 }) => (
  <motion.div 
...
// Skill Bar Component
const SkillBar = ({ label, level, color }: { label: string, level: string, color: string }) => (
  <div className="mb-4">
...
const ToolIcon = ({ name, bg, txt }: { name: string, bg: string, txt: string }) => (
  <motion.div 
    ...
    <section id="about" className="py-32 px-4 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-32 relative flex justify-center items-center select-none">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[12rem] md:text-[20rem] font-display font-bold leading-none text-transparent stroke-text opacity-[0.03] pointer-events-none" 
            ...
            <div className="relative z-10 text-center">
                ...
                >
                    ...
                    {/* Hand-drawn Arrow SVG */}
                     <svg className="absolute top-full left-1/2 w-8 h-8 text-design-yellow" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute -top-6 left-0 w-full h-4 border-b border-white/20 flex justify-between items-end px-1 opacity-50 group-hover:opacity-100 transition-opacity">
                            ...
                            <span className="text-[9px] text-gray-500 font-mono mb-1">auto-width</span>
                            <div className="h-2 w-px bg-white/20"></div>
                        </div>

                        <h2 className="text-[15vw] md:text-[9rem] font-black text-white leading-[0.85] tracking-tighter cursor-default"
                        ...
                        >
                            ...
                            <div className="space-y-1.5">
                                <div className="flex justify-between items-center text-[9px]">
                                    ...
                                    <span className="text-design-green font-mono bg-design-green/10 px-1 rounded">Active</span>
                                </div>
                                <div className="flex justify-between items-center text-[9px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
          ...
          <UIPanel className="lg:col-span-7 flex flex-col justify-center bg-[#151515]">
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light">
              As an emerging <span className="text-design-blue font-bold">UI/UX Designer</span>, I bring a <span className="text-design-blue">fresh blend of creativity</span> and analytical thinking to the design table.
            </p>
            <p className="mt-6 text-gray-400">
              Possessing a foundational knowledge of design principles and a keen eye for detail, I am committed to crafting intuitive and engaging interfaces. Eager to learn and grow within this dynamic field.
            </p>
          </UIPanel>
          ...
          <UIPanel className="lg:col-span-4" delay={0.2}>
             <h3 className="text-2xl font-display font-bold text-design-purple mb-6">EDUCATION</h3>
             ...
             <div className="space-y-6">
                <div className="relative pl-6 border-l border-design-purple/30">
                   ...
                   <span className="text-xs text-design-purple font-mono mb-1 block">2019 - 2023</span>
                   <h4 className="text-white font-bold">Bachelor Degree</h4>
                   <p className="text-sm text-gray-500">Business English</p>
                   <p className="text-xs text-gray-600">HCM City University</p>
                </div>

                <div className="relative pl-6 border-l border-design-purple/30">
                   <div className="absolute -left-1.5 top-1.5 w-3 h-3 bg-design-purple rounded-full border-4 border-[#1A1A1A]" />
                   <span className="text-xs text-design-purple font-mono mb-1 block">2023</span>
                   <h4 className="text-white font-bold">Google UX Design</h4>
                   <p className="text-sm text-gray-500">Specialization Certificate</p>
                   <p className="text-xs text-gray-600">Coursera</p>
                </div>
             </div>

             <h3 className="text-2xl font-display font-bold text-design-green mt-10 mb-6">EXPERIENCE</h3>
             <div className="relative pl-6 border-l border-design-green/30">
                ...
                <span className="text-xs text-design-green font-mono mb-1 block">Jul 2023 - Present</span>
                <h4 className="text-white font-bold">UI/UX Designer</h4>
                <p className="text-sm text-gray-500">Ebizworld Software</p>
             </div>
          </UIPanel>

          {/* 4. SKILLS & LANGUAGES (Span 4) */}
          <UIPanel className="lg:col-span-4" delay={0.3}>
            <h3 className="text-2xl font-display font-bold text-design-orange mb-6">SKILLS</h3>
            
            <div className="flex flex-wrap gap-2 mb-8">
               {['User Research', 'Wireframing', 'Prototyping', 'Visual Design', 'Design Systems', 'HTML & CSS'].map(skill => (
                  <span key={skill} className="px-3 py-1.5 bg-[#2A2A2A] text-gray-300 text-xs font-medium rounded-lg border border-white/5 hover:border-design-orange hover:text-design-orange transition-colors cursor-default">
                     {skill}
                  </span>
               ))}
            </div>

            <h3 className="text-2xl font-display font-bold text-design-blue mb-6">LANGUAGES</h3>
            <SkillBar label="Vietnamese" level="100%" color="#3b82f6" />
            <SkillBar label="English" level="85%" color="#60a5fa" />
            
            {/* Simple QR Code Placeholder */}
            <div className="mt-8 p-4 bg-white rounded-xl flex items-center gap-4 group cursor-pointer hover:bg-design-blue transition-colors">
               <div className="w-12 h-12 bg-black opacity-10" /> {/* QR pattern simulation */}
               <svg viewBox="0 0 24 24" fill="none" className="w-12 h-12 text-black" stroke="currentColor" strokeWidth="2">
                  <path d="M3 3h6v6H3zM15 3h6v6h-6zM3 15h6v6H3zM15 15h6v6h-6zM7 7h.01M17 7h.01M7 17h.01M17 17h.01" />
               </svg>
               <div className="flex flex-col">
                  <span className="text-black font-bold text-sm group-hover:text-white">SCAN ME</span>
                  <span className="text-gray-500 text-xs group-hover:text-white/80">to get Resume</span>
               </div>
            </div>
          ...
          {/* 5. TOOLS (Span 4) */}
          <UIPanel className="lg:col-span-4 flex flex-col items-center justify-center bg-[#181818]" delay={0.4}>
             <h3 className="text-2xl font-display font-bold text-design-pink mb-8 w-full text-center">TOOLS</h3>
             ...
             <div className="grid grid-cols-3 gap-4">
                ...
                <div className="w-16 h-16 rounded-xl flex items-center justify-center bg-gray-800 text-gray-500 text-2xl font-bold">+</div>
             </div>
             
             <div className="mt-8 text-center">
               <span className="text-xs text-gray-500 uppercase tracking-widest">Visual Development</span>
             </div>
          </UIPanel>
