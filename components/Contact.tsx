...
const GlobeIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1 4-10z"/></svg>
);
...
const CONTACTS: ContactItem[] = [
  {
    id: 'email',
    name: 'Hoang Quy',
    handle: 'hoangquy.design@gmail.com',
    role: 'Owner',
...
const ContactRow: React.FC<{ item: ContactItem, onAction: (item: ContactItem) => void }> = ({ item, onAction }) => {
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3">
                <div className={`w-8 h-8 rounded-full ${item.avatarColor} flex items-center justify-center text-[10px] font-bold text-white shadow-inner`}>
                    {item.initial}
                </div>
                <div className="flex flex-col">
                    <span className="text-sm font-bold text-gray-200 leading-none mb-1">{item.name}</span>
                    <span className="text-[11px] text-gray-500 font-mono">{item.handle}</span>
                </div>
            </div>

            <div className="flex items-center gap-2">
                <span className="text-xs text-gray-400 group-hover:text-white transition-colors">{item.role}</span>
  ...
  author: string 
    ...
    return (
        <motion.div
            drag
            dragMomentum={false}
            whileDrag={{ scale: 1.1, rotate: 0, zIndex: 50, boxShadow: "0px 20px 40px rgba(0,0,0,0.3)" }}
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-[#2c2c2e] border border-white/10 p-2 rounded-xl flex gap-4 shadow-2xl z-20 pointer-events-none">
                 <div className="w-8 h-8 rounded-lg bg-design-blue flex items-center justify-center text-white"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 3L10.07 19.97L12.58 12.58L19.97 10.07L3 3Z"/></svg></div>
                 <div className="w-8 h-8 rounded-lg hover:bg-white/10 flex items-center justify-center text-gray-400"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div>
                 <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center text-white border border-design-pink"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="currentColor"/></svg></div>
            </div>

            {/* Draggable Sticky Notes - Spread out more for wider canvas */}
            <StickyNote text="Let's build something epic!" color="bg-[#FFBD2E]" rotate={-5} x={40} y={40} author="You" />
            <StickyNote text="Clean code & great vibes." color="bg-[#FF5F56]" rotate={4} x={350} y={120} author="Dev" />
            <StickyNote text="Check out the case studies!" color="bg-[#27C93F]" rotate={-2} x={80} y={350} author="PM" />
            ...
            >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-design-purple drop-shadow-md">
                   <path d="M3 3L10.07 19.97L12.58 12.58L19.97 10.07L3 3Z" fill="currentColor" stroke="white" strokeWidth="2" strokeLinejoin="round"/>
                </svg>
                <div className="absolute left-4 top-4 bg-design-purple text-white text-[10px] font-bold px-2 py-0.5 rounded-full whitespace-nowrap">Sarah</div>
            </motion.div>
            ...
            >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-design-orange drop-shadow-md">
                   <path d="M3 3L10.07 19.97L12.58 12.58L19.97 10.07L3 3Z" fill="currentColor" stroke="white" strokeWidth="2" strokeLinejoin="round"/>
                </svg>
                <div className="absolute left-4 top-4 bg-design-orange text-white text-[10px] font-bold px-2 py-0.5 rounded-full whitespace-nowrap">Mike</div>
            </motion.div>
...
const Contact: React.FC = () => {
    ...
    return (
    <section id="contact" className="min-h-screen flex flex-col justify-center py-20 px-4 relative max-w-[1600px] mx-auto overflow-hidden">
        ...
        <div className="mb-24 relative flex flex-col items-center justify-center select-none">
            ...
            >
                ...
                <span className="text-xs font-bold text-gray-300 tracking-wide">STATUS: <span className="text-design-green">ONLINE</span></span>
                <div className="w-px h-4 bg-white/10 mx-2" />
                <span className="text-[10px] text-gray-500 font-mono">12ms latency</span>
            </motion.div>
            ...
            <div className="relative z-10 text-center">
                 ...
                 >
                     <motion.div animate={{ opacity: [0.4, 1, 0.4] }} transition={{ duration: 1, repeat: Infinity, delay: 0 }} className="w-1.5 h-1.5 bg-black rounded-full" />
                     <motion.div animate={{ opacity: [0.4, 1, 0.4] }} transition={{ duration: 1, repeat: Infinity, delay: 0.2 }} className="w-1.5 h-1.5 bg-black rounded-full" />
                     <motion.div animate={{ opacity: [0.4, 1, 0.4] }} transition={{ duration: 1, repeat: Infinity, delay: 0.4 }} className="w-1.5 h-1.5 bg-black rounded-full" />
                 </motion.div>

                 <div className="flex flex-col items-center leading-none">
                    <h2 className="text-6xl md:text-9xl font-black text-transparent stroke-text tracking-tighter hover:text-white transition-colors duration-500 cursor-default" style={{ WebkitTextStroke: '2px #fff' }}>
                        LET'S
                    </h2>
                    <motion.div 
             ...
             >
                Initiate a handshake protocol. Whether it's a project inquiry or a tech discussion, my inbox is always listening.
             </motion.p>
            ...
            >
                ...
                <div className="p-4 border-b border-white/10 flex items-center justify-between bg-[#252525]">
                    <h3 className="text-sm font-bold text-white flex items-center gap-2">
                        ...
                        <span className="px-1.5 py-0.5 bg-black/30 text-[9px] text-gray-400 rounded border border-white/5">READ-ONLY</span>
                    </h3>
                ...
                <div className="p-6">
                    <div className="flex gap-3 mb-6">
                        ...
                        <button 
                            ...
                            onMouseLeave={() => setLabel(null)}
                            onClick={() => window.location.href = "mailto:hoangquy.design@gmail.com"}
                        >
                            Invite
                        </button>
                    </div>
                    ...
                    <div className="mb-2">
                        <h4 className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">People with access</h4>
                    </div>

                    <div className="space-y-1">
                        {CONTACTS.map((contact) => (
                            <ContactRow key={contact.id} item={contact} onAction={handleAction} />
                        ))}
                    </div>
                </div>
