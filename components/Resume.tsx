...
const HolographicCard = () => {
  ...
  return (
    ...
    >
        ...
        {/* Noise Texture */}
        <div className="absolute inset-0 opacity-20 z-0" style={{ backgroundImage: 'url("https://grainy-gradients.vercel.app/noise.svg")' }} />
        ...
        <div className="relative z-10 p-6 flex justify-between items-start">
            <div className="flex items-center gap-2">
                 ...
                 <div className="flex flex-col">
                    <span className="text-[9px] text-gray-400 uppercase tracking-widest font-bold">Access Level</span>
                    <span className="text-xs text-white font-mono font-bold">ADMIN_V2.0</span>
                 </div>
            </div>
            {/* Sim Card Chip */}
        ...
        <div className="relative z-10 px-6 flex-1 flex flex-col justify-center items-center text-center">
            ...
            <h3 className="text-2xl font-black text-white mb-1 uppercase tracking-tight">{AUTHOR_NAME}</h3>
             ...
             <div className="h-12 bg-white p-1 rounded-sm flex items-center justify-center overflow-hidden">
                 ...
                 <div className="flex gap-0.5 w-full h-full justify-center opacity-80">
                     {Array.from({length: 40}).map((_, i) => (
                         <div key={i} className="bg-black h-full" style={{ width: Math.random() * 4 + 1 }} />
                     ))}
                 </div>
             </div>
        ...
        <div className="w-full max-w-md bg-[#0D1117] rounded-xl border border-white/10 shadow-2xl overflow-hidden flex flex-col font-mono text-xs h-[320px]">
            ...
            <div className="p-4 flex-1 text-gray-300 space-y-2 overflow-hidden">
                ...
                <div className="opacity-70">
                    <p className="text-gray-500 text-[10px] mb-1">... resolving dependencies</p>
                    <p className="text-gray-500 text-[10px] mb-1">... fetching career_data.json</p>
                    <p className="text-gray-500 text-[10px] mb-3">... verifying skills integrity</p>
                </div>

                <div className="border-l-2 border-design-blue pl-3 py-1 text-gray-400">
                    <p>Name: <span className="text-white">Hoang Quy</span></p>
                    <p>Role: <span className="text-design-yellow">Creative Developer</span></p>
                    <p>Stack: <span className="text-design-purple">[React, Next, Framer]</span></p>
                    <p>Location: <span className="text-white">Vietnam</span></p>
                </div>

                <div className="flex items-center gap-2 pt-2">
                    <span className="text-design-green">✔</span>
                    <span className="text-white font-bold">Package installed successfully.</span>
                </div>
...
const Resume: React.FC = () => {
  return (
    <section id="resume" className="py-32 px-4 relative overflow-hidden min-h-screen flex items-center">
        
        {/* === NEW HEADER DESIGN: CAREER LAUNCHPAD === */}
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
             {/* 1. Wireframe Number Background */}
            <div className="absolute top-[10%] left-1/2 -translate-x-1/2 text-[15rem] md:text-[25rem] font-display font-bold leading-none text-transparent stroke-text opacity-[0.03] pointer-events-none z-0 select-none" 
                     ...
                     <div className="relative">
                        ...
                        <svg className="absolute -left-12 top-1/2 w-12 h-px hidden lg:block overflow-visible">
                            <motion.line 
                                ...
                                stroke="#333" strokeWidth="2" strokeDasharray="4 4"
