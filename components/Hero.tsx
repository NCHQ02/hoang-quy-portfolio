...
const SelectionHandle = ({ className }: { className?: string }) => (
  <div
    className={`absolute w-3 h-3 bg-white border border-blue-500 rounded-[1px] z-20 ${className}`}
  />
);
        ...
        <div className="relative w-full h-32 md:h-40 flex justify-center items-end mb-4">
          ...
          >
            ...
            <svg
              ...
              className="text-design-pink"
            >
              <path
                d="M12 2C9 2 7 4 7 7V9C4 9 2 11 2 14C2 17.5 5 21 12 21C19 21 22 17.5 22 14C22 11 20 9 17 9V7C17 4 15 2 12 2Z"
                fill="currentColor"
                fillOpacity="0.2"
              />
              <path
                d="M8 9V7C8 5.5 9 3.5 12 3.5C15 3.5 16 5.5 16 7V9"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
              />
              ...
              />
              <path
                d="M11 17C11 17 11.5 17.5 12 17.5C12.5 17.5 13 17 13 17"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
              />
            ...
            {/* Sparkles */}
            <div className="absolute -top-2 -right-3 text-design-pink text-xl">
              ✨
            </div>
          </motion.div>
        ...
        >
          ...
          >
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="text-design-blue drop-shadow-lg"
            >
              <path
